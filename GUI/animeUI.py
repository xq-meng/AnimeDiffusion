...
from GUI.runner import ModelRunner
from GUI.message_box import MessageBox
from GUI.candidate_list import CandidateList
...
class AnimeUI(QMainWindow):
    ...
    def __init__(self, config=None):
        ...
        self.__init_ui__()
        self.show()
        self.__init_data__(config=config)
    ...
    def __init_data__(self, config=None):
        self.img_ref = []
        ...
        self.runner = ModelRunner(config, ui_logger)
    ...
    def __open_condition_image_file__(self):
        ...
        if filename:
            ...
            self.runner.sketch = self.sketch_image
